...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get_success(self):
        ...
        self.assertNotEqual(storage.get(State, new_state.id), None)
        new_city.save()
        self.assertEqual(storage.get(City, new_city.id), new_city)
        self.assertIsInstance(storage.get(City, new_city.id), City)
        self.assertNotEqual(storage.get(City, new_city.id), None)
